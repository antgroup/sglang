...
def validate_hisparse(server_args: ServerArgs) -> None:
    ...
    enable_speculative_decoding = (
        ...
        and server_args.speculative_algorithm.upper() != "NONE"
    )
    if enable_speculative_decoding and (server_args.speculative_eagle_topk or 1) != 1:
        raise ValueError(
            "The minimal HiSparse MTP integration supports linear speculation "
