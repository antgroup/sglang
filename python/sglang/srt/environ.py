...
class Envs:
    ...
    # Use the fused-transpose NVLink-P2P all-to-all for Ulysses sequence
    # parallel in multimodal diffusion. Unsupported shapes and topologies
    # retain the standard all-to-all fallback.
    SGLANG_ENABLE_ULYSSES_P2P_A2A = EnvBool(False)
    SGLANG_ENABLE_ULYSSES_P2P_A2A_TK_STYLE = EnvBool(True)
    # Compatibility gates used by existing LingBot deployment scripts.
