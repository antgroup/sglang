...
def _register_configs():
    ...
    register_configs(
        sampling_param_cls=LingBotWorldSamplingParams,
        pipeline_config_cls=LingBotWorldLegacyCompatCausalDMDConfig,
    ...
    register_configs(
        sampling_param_cls=LingBotWorldSamplingParams,
        pipeline_config_cls=LingBotWorldLegacyCompatI2VConfig,
        hf_model_paths=["FastVideo/LingBot-World-Base-Cam-Diffusers"],
        model_detectors=[lambda hf_id: "lingbotworld" in hf_id.lower()],
    )
    register_configs(
