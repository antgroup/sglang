...
# ruff: noqa
"""Vendored Wan DiT implementation required by FlashVSR Tiny Long."""
...
from .model_utils import hash_state_dict_keys
...
class CrossAttention(nn.Module):
    """Text cross-attention with persistent KV cache."""
    ...
    def init_cache(self, ctx: torch.Tensor):
        """ctx: [B, S_ctx, dim] after text_embedding."""
...
# ----------------------------
# WanModel without the image branch.
# ----------------------------
class WanModel(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # CrossAttention ignores this context when its cache is initialized.
