...
"""
LingBot-World offline image-to-video pipeline.
"""
...
class LingBotWorldImageToVideoPipeline(LoRAPipeline, ComposedPipelineBase):
    pipeline_name = "LingBotWorldImageToVideoPipeline"
