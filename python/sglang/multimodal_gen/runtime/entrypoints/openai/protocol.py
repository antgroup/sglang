...
class RealtimeVideoGenerationsRequest(VideoGenerationsRequest):
    # Keep the legacy request (which omitted "type") valid while supporting
    # the mainline init/event protocol.
...
class RealtimeAction(BaseModel):
    """Legacy realtime action accepted by pre-mainline LingBot clients."""
